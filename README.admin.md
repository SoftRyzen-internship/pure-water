...
![media](public/images/admin/media.jpg =96x55)
...
![settings](public/images/admin/settings.jpg =80x55)
...
![search](public/images/admin/search.jpg =70x55)

Іконка пошуку дозволяє робити пошук інформації в додатку.

![status](public/images/admin/status.jpg =114x55)
...
![initials](public/images/admin/initials.jpg =62x55)

Пункт меню з ініціалами користувача у верхньому правому кутку відкриває меню
користувача:

![menu](public/images/admin/menu.jpg =80x120)
...
## _Даний підхід не є обов’язковим. Користувач має можливість змінити структуру збереження зображень на свій розсуд_
...
При натисканні іконки ![icon](public/images/admin/func-icon.jpg =62x55) поруч з
іменем папки відкривається меню дій для відповідної папки:
...
## _Для коректного відображення сторінок сайту користувач адмін-панелі повинен задати контент обома мовами._
...
**⚠️Важливо!** Збереження оновлених даних в БД адмін-панелі не призводить до
відображення їх на сторінках сайту. Для того, щоб оновлені дані стали видимими
на сайті, необхідно виконати процедуру деплою, що описана далі в документі в
розділі Надсилання оновленої інформації на сайт.
...
**⚠️Важливо!** Списки проєктів англійською і українською – це фактично два
окремих списка. Користувач адмін-панелі за бажанням може створити різні переліки
проєктів для кожної з мов відтворення.
...
відкривається при кліку на трикрапку (![search](public/images/admin/search.jpg
=70x55)) в кінці рядка._

**⚠️Важливо!** Перше по порядку зображення в списку буде використано як фото на
картці проєкту. Рекомендовано першим ставити фото в альбомній (landscape)
орієнтації зі співвідношенням сторін 4:3.
...
**⚠️Важливо!** Якщо зміни не з’явились на сторінках сайту після успішного
деплою, слід очистити кеш браузера.
