...
![ЧИСТА ВОДА ВСІМ](./public/images/screenshots/adaptive-hero.jpg)
...
- Оптимізація: Веб-сайт "Чиста вода всім" оптимізований для швидкого
  ...
  ![Швидкість завантаження сторінки](./public/images/screenshots/page-speed.jpg)
...
[Адмін-панель](https://pure-water.admin.datocms.com/editor)

[📝 Інструкція до адмін-панелі DatoCMS](./README.admin.md)
